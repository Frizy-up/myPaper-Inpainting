...
Mehdi generated against the conditions of network model is put forward, in the generated model and the discriminant model are introduced in the modeling of condition variables, and use the additional information on the model increase condition, can guide the data generation process. It creates an image of the specified category on the MNIST dataset with a category label as a condition variable.
