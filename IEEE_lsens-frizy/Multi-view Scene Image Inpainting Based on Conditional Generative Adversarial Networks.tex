...
\begin{figure*}[t]
\centering
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/lp-left-image_00004944_0-inputs.png}%
\label{fig:experiment3:input}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/lp-left-image_00004944_0-conditions.png}%
\label{fig:experiment3:condition}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/lp-left-image_00004944_0-targets.png}%
\label{fig:experiment3:target}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/lp-left-image_00004944_0-stns.png}%
\label{fig:experiment3:stn}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:ours}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/PatchMatch/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:patchMatch}}
\vfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/L2&noCondition/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:context-encoder}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noMultiViews/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:Image-to-Image}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noShuffle/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:noShuffle}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noSTN/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:noSTN}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noGAN/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:noGAN}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noL1/lp-left-image_00004944_0-outputs.png}%
\label{fig:experiment3:noL1}}
\caption{Compare different image inpainting methods. (a) Input Left camera image. (b) Right camera image. (c) Target image. (d) The STN result. (e) Ours result. (f) Patch Match result. (g) Contexter-encoder result. (h) Image-to-Image result. (i) Ours(no shuffle) result. (j) Ours(no STN) result. (k) Ours(no GAN) result. (l) Ours(no L1) result.}
...
\begin{figure*}[t]
\centering
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/1-left-image_00000117_0-inputs.png}%
\label{fig:experiment:input}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/1-left-image_00000117_0-conditions.png}%
\label{fig:experiment:condition}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/1-left-image_00000117_0-targets.png}%
\label{fig:experiment:target}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/1-left-image_00000117_0-stns.png}%
\label{fig:experiment:stn}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:ours}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/PatchMatch/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:patchMatch}}
\vfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/L2&noCondition/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:context-encoder}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noMultiViews/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:Image-to-Image}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noShuffle/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:noShuffle}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noSTN/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:noSTN}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noGAN/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:noGAN}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noL1/1-left-image_00000117_0-outputs.png}%
\label{fig:experiment:noL1}}
\caption{Compare different image inpainting methods. (a) Input Left camera image. (b) Right camera image. (c) Target image. (d) The STN result. (e) Ours result. (f) Patch Match result. (g) Contexter-encoder result. (h) Image-to-Image result. (i) Ours(no shuffle) result. (j) Ours(no STN) result. (k) Ours(no GAN) result. (l) Ours(no L1) result.}
...
\begin{figure*}[t]
\centering
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/5-left-image_00000604_0-inputs.png}%
\label{fig:experiment2:input}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/5-left-image_00000604_0-conditions.png}%
\label{fig:experiment2:condition}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/5-left-image_00000604_0-targets.png}%
\label{fig:experiment2:target}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/5-left-image_00000604_0-stns.png}%
\label{fig:experiment2:stn}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/ours/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:ours}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/PatchMatch/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:patchMatch}}
\vfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/L2&noCondition/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:context-encoder}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noMultiViews/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:Image-to-Image}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noShuffle/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:noShuffle}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noSTN/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:noSTN}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noGAN/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:noGAN}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{experiment-results/myExampare/noL1/5-left-image_00000604_0-outputs.png}%
\label{fig:experiment2:noL1}}
\caption{Compare different image inpainting methods. (a) Input Left camera image. (b) Right camera image. (c) Target image. (d) The STN result. (e) Ours result. (f) Patch Match result. (g) Contexter-encoder result. (h) Image-to-Image result. (i) Ours(no shuffle) result. (j) Ours(no STN) result. (k) Ours(no GAN) result. (l) Ours(no L1) result.}
...
\begin{figure*}[t]
\centering
\subfloat[]{\includegraphics[width=1.0in]{random/3-left-image_00000615_0-inputs.png}%
\label{fig:experiment_random:input}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/3-left-image_00000615_0-conditions.png}%
\label{fig:experiment_random:condition}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/3-left-image_00000615_0-targets.png}%
\label{fig:experiment_random:target}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/3-left-image_00000615_0-stns.png}%
\label{fig:experiment_random:stn}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/3-left-image_00000615_0-outputs.png}%
\label{fig:experiment_random:ours}}

\caption{Compare different image inpainting methods. (a) Input Left camera image. (b) Right camera image. (c) Target image. (d) The STN result. (e) Ours result.}
\label{fig:experiment_random}
\end{figure*}

\begin{figure*}[t]
\centering
\subfloat[]{\includegraphics[width=1.0in]{random/5-left-image_00000826_0-inputs.png}%
\label{fig:experiment_random2:input}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/5-left-image_00000826_0-conditions.png}%
\label{fig:experiment_random2:condition}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/5-left-image_00000826_0-targets.png}%
\label{fig:experiment_random2:target}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/5-left-image_00000826_0-stns.png}%
\label{fig:experiment_random2:stn}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/5-left-image_00000826_0-outputs.png}%
\label{fig:experiment_random2:ours}}

\caption{Compare different image inpainting methods. (a) Input Left camera image. (b) Right camera image. (c) Target image. (d) The STN result. (e) Ours result.}
\label{fig:experiment_random2}
\end{figure*}

\begin{figure*}[t]
\centering
\subfloat[]{\includegraphics[width=1.0in]{random/lp-left-image_00005496_0-inputs.png}%
\label{fig:experiment_random3:input}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/lp-left-image_00005496_0-conditions.png}%
\label{fig:experiment_random3:condition}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/lp-left-image_00005496_0-targets.png}%
\label{fig:experiment_random3:target}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/lp-left-image_00005496_0-stns.png}%
\label{fig:experiment_random3:stn}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/lp-left-image_00005496_0-outputs.png}%
\label{fig:experiment_random3:ours}}

\caption{Compare different image inpainting methods. (a) Input Left camera image. (b) Right camera image. (c) Target image. (d) The STN result. (e) Ours result.}
\label{fig:experiment_random3}
\end{figure*}

\begin{figure*}[t]
\centering
\subfloat[]{\includegraphics[width=1.0in]{random/sun-left-image_00000418_0-inputs.png}%
\label{fig:experiment_random4:input}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/sun-left-image_00000418_0-conditions.png}%
\label{fig:experiment_random4:condition}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/sun-left-image_00000418_0-targets.png}%
\label{fig:experiment_random4:target}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/sun-left-image_00000418_0-stns.png}%
\label{fig:experiment_random4:stn}}
\hfil
\subfloat[]{\includegraphics[width=1.0in]{random/sun-left-image_00000418_0-outputs.png}%
\label{fig:experiment_random4:ours}}

\caption{Compare different image inpainting methods. (a) Input Left camera image. (b) Right camera image. (c) Target image. (d) The STN result. (e) Ours result.}
\label{fig:experiment_random4}
\end{figure*}
